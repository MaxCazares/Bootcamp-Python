...
print(get_exist_key_in_params(name='Max', lastname='Cazares'))   # Max
print(get_exist_key_in_params(lastname='Cazares'))               # No existe name

# Por posición / nombre

is_same_length_args_kwargs = lambda *args, **kwargs : len(args) == len(kwargs)

print(is_same_length_args_kwargs(1,2, name='Max'))                     # False
print(is_same_length_args_kwargs(1,2, name='Max', lastname='Cazares')) # True
